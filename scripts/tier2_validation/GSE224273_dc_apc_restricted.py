...
obs.to_csv(outdir / "GSE224273_dc_apc_all_cells.csv")
apc.to_csv(outdir / "GSE224273_dc_apc_subset.csv")
...
sample_df.to_csv(outdir / "GSE224273_dc_apc_restricted_sample_summary.csv", index=False)
...
for outcome in outcomes:
    ...
    rows.append({
        ...
        "asym_minus_symptomatic_mean": a.mean() - s.mean(),
        "asymptomatic_median": a.median(),
        "symptomatic_median": s.median(),
    })

compare_df = pd.DataFrame(rows)
compare_df.to_csv(outdir / "GSE224273_dc_apc_restricted_group_summary.csv", index=False)
...
print("\nSaved:")
print(outdir / "GSE224273_dc_apc_restricted_sample_summary.csv")
print(outdir / "GSE224273_dc_apc_restricted_group_summary.csv")

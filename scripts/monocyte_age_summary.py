...
summarize(l2, "AIFI_L2", "monocyte_L2")
summarize(l3, "AIFI_L3", "monocyte_L3")

print("Done.")
print(results_dir / "monocyte_L2_agegroup_summary.csv")
print(results_dir / "monocyte_L2_agegroup_mean_delta.csv")
print(results_dir / "monocyte_L3_agegroup_summary.csv")
print(results_dir / "monocyte_L3_agegroup_mean_delta.csv")

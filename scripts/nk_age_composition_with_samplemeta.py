...
obs.to_csv(results_dir / "nk_age_composition_with_samplemeta_input.csv", index=True)
...
l2_counts.to_csv(results_dir / "nk_L2_with_samplemeta.csv", index=False)
...
l3_counts.to_csv(results_dir / "nk_L3_with_samplemeta.csv", index=False)

print("Done.")
print(results_dir / "nk_L2_with_samplemeta.csv")
print(results_dir / "nk_L3_with_samplemeta.csv")

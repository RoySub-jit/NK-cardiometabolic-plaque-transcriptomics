...
l2_counts.to_csv(results_dir / "dc_L2_with_samplemeta.csv", index=False)
...
l3_counts.to_csv(results_dir / "dc_L3_with_samplemeta.csv", index=False)

print("Done.")
print(results_dir / "dc_L2_with_samplemeta.csv")
print(results_dir / "dc_L3_with_samplemeta.csv")

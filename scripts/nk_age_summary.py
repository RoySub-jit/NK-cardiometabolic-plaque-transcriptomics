...
l2_file = results_dir / "nk_subject_level_AIFI_L2_composition_clean.csv"
l3_file = results_dir / "nk_subject_level_AIFI_L3_composition_clean.csv"
...
summarize(l2, "AIFI_L2", "nk_L2")
summarize(l3, "AIFI_L3", "nk_L3")

print("Done.")
print(results_dir / "nk_L2_agegroup_summary.csv")
print(results_dir / "nk_L2_agegroup_mean_delta.csv")
print(results_dir / "nk_L3_agegroup_summary.csv")
print(results_dir / "nk_L3_agegroup_mean_delta.csv")
